...
class UserModelCase(unittest.TestCase):
	...
	def test_password_hashing(self):
		print('>>>>>>>>>>>>>>>> test.py: run password_hashing test', file=sys.stdout)
	...
	def test_avatar(self):
		print('>>>>>>>>>>>>>>>> test.py: run avatar test', file=sys.stdout)
	...
	def test_follow(self):
		print('>>>>>>>>>>>>>>>> test.py: run follow test', file=sys.stdout)
	...
	def test_follow_posts(self):
		print('>>>>>>>>>>>>>>>> test.py: run post follow test', file=sys.stdout)
